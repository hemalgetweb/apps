<!-- brand area start -->
<div class="brand-area ayaa-fz-brand-area-5">
    <div class="container">
        <div class="ayaa-rv-brand-wrapper">
            <?php if(!empty($settings['slides'])) : ?>
            <div class="ayaa-fz-brand-active-backward swiper-container mb-30 roll__slider">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9">
                    ...
                    <div class="ayaa-rv-brand-forward-wrapper">
                        <div class="ayaa-fz-brand-active-forward swiper-container roll__slider"  dir="rtl">
                            <div class="swiper-wrapper roll__wrapper">
