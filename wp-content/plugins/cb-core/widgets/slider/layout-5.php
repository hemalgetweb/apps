<!-- ayaa-fz-slider-5-area-start -->
<section class="ayaa-fz-slider-5-area bg-rightcenter fix" data-bgcolor="#000000">
    <div class="fz-line-wrapp">
        <div class="fz-line-item"></div>
    </div>
    <div class="container"> 
        <div class="ayaa-fz-slider-5-wrapper">
        <div class="ayaa-fz-slider-5-star">
            ...
            <div class="row align-items-center">
                <div class="col-xl-12">
                    <div class="ayaa-fz-slider-5-content-wrapper">
                        <?php if(!empty($settings['section_bg_image']['url'])) : ?>
                        <div class="ayaa-fz-slider-5-makrosha-jal"><?php echo \Elementor\Group_Control_Image_Size::get_attachment_image_html( $settings, 'full', 'section_bg_image' ); ?></div>
                        <?php endif;?>
                        <?php if(!empty($settings['slides'])) : ?>
                        <div class="ayaa-fz-slider-5-content-active swiper-container swiper">
                            <div class="swiper-wrapper">
                                <?php foreach($settings['slides'] as $slide) : ?>
                                    <div class="swiper-slide h-870">
                                        <div class="ayaa-fz-slider-5-content-wrapper">
                                            <?php if(!empty($slide['slider_image']['url'])) : ?>
                                            <div class="ayaa-fz-slider-5-watch-img">
                                                <img src="<?php echo esc_url($slide['slider_image']['url']) ?>" alt="<?php echo \Elementor\Control_Media::get_image_alt( $slide['slider_image'] ); ?>">
                                            </div>
                                            <?php endif;?>
                                            <div class="ayaa-slider-5-content">
                                                <?php if(!empty($slide['title'])) : ?>
                                                <h2 class="ayaa-fz-slider-5-title "><?php echo cb_core_kses_basic($slide['title']); ?></h2>
                                                <?php endif;?>
                                                <?php if(!empty($slide['content'])) : ?>
                                                <div class="ayaa-fz-slide5-text-wrap mt-50 pl-365">
                                                    <p class="ayaa-slide5-text mb-0"><?php echo cb_core_kses_basic($slide['content']); ?></p>
                                                </div>
                                                <?php endif;?>
                                                <?php if(!empty($slide['btn_text'])) : ?>
                                                    <div class="fz_btn_wrapper ayaa-fz-slider-5-btn mtm-25">
                                                        <a href="<?php echo esc_url($slide['btn_link']['url']) ? esc_url($slide['btn_link']['url']): ''; ?>" class="ayaa-fz-slider-round-link-4 fz-btn-hover fz-btn-item"><span></span><?php echo esc_html($slide['btn_text']); ?> <i class="fa-light fa-arrow-up-right"></i></a>
                                                    </div>
                                                <?php endif;?>
                                            </div> 
                                        </div>
                ...
                <div class="ayaa-fz-slider5-pagination"></div>
            </div>
        </div>
    </div>
