...
<div class="news-area pt-100 pb-120">
    <div class="container">
        ...
        <div class="apps-fz-section-title-wrapper-6 text-center pb-50">
            <h3 class="apps-fz-section-title-6 mb-0"><?php echo cb_core_kses_basic($settings['section_title']); ?></h3>
        </div>
        <?php endif;?>
        <?php if ($wp_query->have_posts()) : ?>
        <div class="apps-fz-news-inner-main-wrapper-6">
            <div class="row justify-content-center">
                <?php
                    while ($wp_query->have_posts()) : $wp_query->the_post();
                ?>
                <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
                    <div class="apps-fz-news-box-6 pb-30">
                        <a class="blog" href="<?php echo esc_url(get_the_permalink()); ?>">
                            <div class="apps-fz-blog-news-thumb-6 fz-filter-image-box">
                                <?php echo the_post_thumbnail(); ?>
                                <?php echo the_post_thumbnail(); ?>
                            </div>
                        </a>
                        <div class="apps-fz-news-blog-content-6">
                            <div class="apps-fz-news-blog-meta-6">
