    ...
    <div class="container">
        <div class="row gy-3 justify-content-center">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="product-card ayaa-product-card-1">
                    <div class="part-txt">
                        <h4 class="price">
                        ...
                        <?php if(!empty($slide['btn_text'])) : ?>
                            <a href="<?php echo esc_url($slide['btn_link']['url'] ? $slide['btn_link']['url'] : ''); ?>" class="def-btn-2"><?php echo cb_core_kses_basic($slide['btn_text']); ?></a>
                        <?php endif; ?>
                    </div>
                    <div class="part-img">
