    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xxl-6 col-xl-6 col-lg-7">
                <div class="apps-about-content-right-7-114">
                    <div class="apps-about-section-title-wrapper-7-114">
                        <?php if(!empty($settings['about_subtitle'])) : ?>
                            <span class="subtitle"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/rect.svg" alt="rect"> <?php echo wp_kses_post($settings['about_subtitle']); ?></span>
                        <?php endif; ?>
                        <?php if(!empty($settings['about_title'])) : ?>
                            <h5 class="title"><?php echo wp_kses_post($settings['about_title']); ?></h5>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="apps-about-list-wrapper-7-114">
                        <div class="row">
                            ...
                            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                <div class="apps-about-list-box-wrapper-7-114 mb-30">
                                    <div class="icon">
                                        <?php echo wp_get_attachment_image( $slide['list_item_image']['id'], 'thumbnail' ); ?>
                                    </div>
                                    <div class="content">
                                        <?php if(!empty($slide['list_item_text'])) : ?>
                                            <h5 class="title"><?php echo wp_kses_post($slide['list_item_text']); ?></h5>
                                        <?php endif; ?>
