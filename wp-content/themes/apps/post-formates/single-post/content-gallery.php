...
<article id="post-<?php the_ID(); ?>" <?php post_class('single-blog format-gallery mb-40'); ?>>
    ...
    <?php if ( !empty( $post_gallery ) ): ?>
        <div class="blog-thumb swiper-container apps-blog-box-gallery">
            <div class="owl-carousel apps-blog-slider apps-has-default-carousel-nav">
                <?php foreach ( $post_gallery as $image ): ?>
                    <div class="owl-slide">
                        <div class="apps-fz-thumbnail-image apps-fz-blog-thumbnail-447">
