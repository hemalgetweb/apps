    ...
    class WP_Bootstrap_Navwalker extends Walker_Nav_Menu {
        ...
        public function start_el( &$output, $item, $depth = 0, $args = null, $id = 0 ) {
            ...
            if ( $this->has_children ) {
                $classes[] = 'has-menu-children dropdown';
            }
        ...
        public static function fallback( $args ) {
            ...
            $fallback_output .= '<li class="nav-item"><a href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '" title="' . esc_attr__( 'Add a menu', 'apps' ) . '">' . esc_html__( 'Add a menu', 'apps' ) . '</a></li>';
            $fallback_output .= '</ul>';
