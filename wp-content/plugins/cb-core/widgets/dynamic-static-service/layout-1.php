                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <a class="service-box-card-wrap d-block" href="<?php echo $slide['service_title_link']['url'] ? esc_url($slide['service_title_link']['url']): ''; ?>">
                            <div class="dynamic-service-box-114 dynamic-service-box-129" style="min-height: <?php echo $card_height ? $card_height. ';': ' ;'; ?> <?php echo $card_hide_border ? 'border: 0; box-shadow: 0px 20px 40px 0px rgba(0, 57, 89, 0.10);': ' ;'; ?>">
                                <div class="">
