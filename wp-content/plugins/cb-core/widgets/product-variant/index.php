 ...
 * @since 1.0.0
 */
class CB_Core_Woo_Product_Variant extends Widget_Base
{
	...
	{
		return __('CB Woo Product Variant', 'cb-core');
	}
	...
	protected function register_controls()
	{
		...
		$this->start_controls_section(
			...
			[
				'label' => __('Feature Product', 'cb-core'),
			]
		);
		$this->add_control(
			'feature_title',
		...
		$this->add_control(
			...
			[
				...
				'options' => ayaa_drop_cat_featured('product_cat'),
				'multiple' => true,
				'label_block' => true,
				'condition' => [
					'query_type' => 'category',
...
Plugin::instance()->widgets_manager->register(new CB_Core_Woo_Product_Variant());
