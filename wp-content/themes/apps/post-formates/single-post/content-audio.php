...
$apps_audio_url = function_exists('get_field') ? get_field('fromate_style') : NULL;
...
<article id="post-<?php the_ID(); ?>" <?php post_class('single-blog format-audio mb-40'); ?>>
    ...
    <?php if (!empty($apps_audio_url)) : ?>
        <div class="postbox__audio embed-responsive embed-responsive-16by9 apps-fz-thumbnail-image apps-fz-blog-thumbnail-447">
            <?php echo wp_oembed_get($apps_audio_url); ?>
...
<?php echo esc_html($first_cat_name); ?></a>
                    <?php endif; ?>
                    <?php if (!empty($cbtoolkit_blog_comments_switch)) : ?>
                        <a href="<?php comments_link(); ?>"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
