    ...
    <div class="container">
        <div class="row pb-50">
            <div class="col-xxl-12">
                <div class="apps-fz-section-title-wrapper-4 text-center">
                    <?php if(!empty($settings['section_subtitle'])) : ?>
                        <span class="apps-fz-subtitle-4"><?php echo cb_core_kses_basic($settings['section_subtitle']); ?></span>
                    <?php endif; ?>
                    <?php if(!empty($settings['section_title'])) :?>
                    <h4 class="apps-fz-title-4"><?php echo cb_core_kses_basic($settings['section_title']); ?></h4>
                    <?php endif;?>
                </div>
            </div>
        </div>
        <?php if ($wp_query->have_posts()) : ?>
            <div class="row">
                ...
                <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6 mb-30">
                    <div class="apps-fz-blog-box-4">
                        <?php if(has_post_thumbnail()) : ?>
                        <div class="image">
                            <a href="<?php echo esc_url(get_the_permalink()); ?>"><?php echo the_post_thumbnail(); ?></a>
                        </div>
                        <?php endif; ?>
                        <div class="apps-fz-box-content">
                            <div class="apps-fz-blog-meta-4">
                            ...
                            <div class="apps-fz-blog-author-box-4">
                                <div class="image">
