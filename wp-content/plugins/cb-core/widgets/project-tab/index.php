 ...
 * @since 1.0.0
 */
class CB_Core_ProjectTab extends Widget_Base
{
	...
	{
		return __('CB Project Tab', 'cb-core');
	}
...
Plugin::instance()->widgets_manager->register(new CB_Core_ProjectTab());