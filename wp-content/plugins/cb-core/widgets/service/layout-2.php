    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6 col-sm-6">
                <!-- service box 2 -->
                <div class="apps-service-box-2-114 mb-30 single-blog-card-wrap <?php echo $enable_box_border ? esc_attr__('has-enabled-border', 'cb-core'): ''; ?> <?php echo $settings['enable_box_shadow_effect'] ? esc_attr__('has-shadow-on-hover'): ''; ?>" style="min-height: <?php echo $box_min_height ? $box_min_height. 'px' : ''; ?>">
