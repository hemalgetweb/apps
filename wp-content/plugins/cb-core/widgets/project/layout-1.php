<div class="modal fade apps-portfolio-modal" id="modal_for_project" tabindex="-1"
    aria-labelledby="modal_for_projectLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        ...
        <div class="modal-content bg-transparent">
            <img src="https://www.getwebinc.com/wp-content/uploads/2022/11/Stype-Health-Walk-Tracker-App-Design-Image-Preview-min.png"
                alt="image">
        </div>
    </div>
</div>
                        ...
                        <?php while ($wp_query->have_posts()):
                            ...
                            <div class="swiper-slide">
                                ...
                                <div class="apps-project-card-114">
                                    ...
                                    <div class="apps-project-card-description-wrapper-114">
                                        <div class="row">
                                            <!-- <div class="col-xxl-10 col-xl-10 mb-30 mb-xl-0">
                                                <h5 class="apps-project-card-title-114"><button data-bs-toggle="modal"
                                                        data-bs-target="#modal_for_project"
                                                        data-url="<?php echo $project_big_image ? esc_url($project_big_image) : ''; ?>"
                                                        class="apps-has-portfolio-popup"
                                                        data-title="<?php echo get_the_title(); ?>"><?php echo get_the_title(); ?></button></h5>
                                            ...
                                            <div class="apps-project-card-action-icon-114 text-xl-end">
                                                <button
                                                    data-url="<?php echo $project_big_image ? esc_url($project_big_image) : ''; ?>"
                                                    data-bs-toggle="modal" data-bs-target="#modal_for_project"
                                                    data-title="<?php echo get_the_title(); ?>"
                                                    class="apps-has-portfolio-popup"><img
                                    ...
                                    <div class="apps-portfolio-projects-wrapper d-flex gap-4 justify-content-between">
