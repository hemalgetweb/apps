...
<div class="section-padding bg-clr-deepDark2">
    <div class="section-header text-center">
        <div class="title-hints d-flex align-items-center justify-content-center gap-2 " data-wow-duration="0.200s"
            data-wow-delay="100ms">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/title-process-icon.svg" class="img-fluid"
                alt="icon">
        ...
        <p class="fs-6 text-clr-primary2 ">
            Over the years, we have had the opportunity to work with the leading industries in the UAE. Our client
            base <br class="d-none d-xl-inline">hails from a range of sectors that has helped enrich our knowledge
            base for better services
        </p>
    </div>
    <div class="container">
        <div class="overflow-hidden">
            <div class="instruction-wrap row position-relative g-0 mt-5">
    ...
    <div class="container">
        <div class="section-header text-center mb-5">
            ...
            <h2 class="text-clr-dark1 fw-semi-bold fs-36 ">
                Hear What Our Clients Have to Say about <br />
                Wadi Al Bada It Solution
            </h2>
            <p class="fs-6 text-clr-dark3">
                We feel satisfied only when our clients are happy with our services. We look forward to seeing your
                feedback <br /> here in the coming days!
            </p>
        </div>
            ...
            <div class="client-testimonials-slide">
                <div class="swiper_wrap">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide client-item-wraps radius-16 position-relative">
                                <span class="client-qoute-icon position-absolute">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/client-qoute-icon.svg"
                                ...
                                <div
                                    ...
                                    <div class="ctc-top mb-5">
                                        <h3 class="fs-28 fw-normal text-clr-dark2 mb-4">
                                            Highly recommended digital <b>marketing agency</b>
                                        </h3>
                                        <div class="client-said fs-5 text-clr-dark2">
                                            <p>
                                                We have created a fun digital environment on our website with Wadi
                                                Al Bada’s
                                                direct
                                                involvement. I am a working mom with little technical knowledge, but
                                                the
                                                outreach
                                                team
                                                took care of most of our marketing needs and helped our idea to grow
                                                into a
                                                running
                                    ...
                                    <div class="ctc-bottom d-flex align-items-center gap-2">
                                        <div class="client-img">
                                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/cleint-img.png"
                                                alt="img" class="img-fluid w-auto">
                                        </div>
                    ...
                    <div class="swiper-control">
                        ...
                        <button type="button" class="swiper-next swiper-arrow border-0 ni ni-arrow-right"></button>
                    </div>
                    <!--/ swiper-control -->
                </div>
            </div>
...
<footer class="footer bg-clr-deepDark">
    <div class="container">
        <div
            ...
            <div
                ...
                <div class="contact-element d-flex gap-4 align-items-center">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/element-sing.svg" alt="icon"
                        class="img-fluid">
        ...
        <div class="footer-widget-area">
            <div class="row">
                <div class="col-sm-6 col-md-6 col-xxl-4 mb-3">
                    <div class="footer-widget footer-menu">
                        <h5 class="fw-bold fs-5 text-white pb-4">
                            <span>
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/title-icon.svg"
                        ...
                        <ul class="nav flex-column">
                            <li class="nav-item mb-3">
                                <a href="about.html" class="nav-link p-0 fw-normal fs-14">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M8 14.709L7.229 13.939L11.167 10.001L7.229 6.06297L8 5.29297L12.708 10.001L8 14.709Z"
                                            fill="#8ECFE3" />
                                    </svg>
                                    About
                                </a>
                            ...
                            <li class="nav-item mb-3">
                                <a href="team.html" class="nav-link p-0 fw-normal fs-14">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M8 14.709L7.229 13.939L11.167 10.001L7.229 6.06297L8 5.29297L12.708 10.001L8 14.709Z"
                            ...
                            <li class="nav-item mb-3">
                                <a href="career.html" class="nav-link p-0 fw-normal fs-14">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M8 14.709L7.229 13.939L11.167 10.001L7.229 6.06297L8 5.29297L12.708 10.001L8 14.709Z"
                            ...
                            <li class="nav-item mb-3">
                                <a href="faq.html" class="nav-link p-0 fw-normal fs-14">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M8 14.709L7.229 13.939L11.167 10.001L7.229 6.06297L8 5.29297L12.708 10.001L8 14.709Z"
                            ...
                            <li class="nav-item mb-3">
                                <a href="client.html" class="nav-link p-0 fw-normal fs-14">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M8 14.709L7.229 13.939L11.167 10.001L7.229 6.06297L8 5.29297L12.708 10.001L8 14.709Z"
                            ...
                            <li class="nav-item mb-3">
                                <a href="case-studies.html" class="nav-link p-0 fw-normal fs-14">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M8 14.709L7.229 13.939L11.167 10.001L7.229 6.06297L8 5.29297L12.708 10.001L8 14.709Z"
                            ...
                            <li class="nav-item mb-3">
                                <a href="blog.html" class="nav-link p-0 fw-normal fs-14">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M8 14.709L7.229 13.939L11.167 10.001L7.229 6.06297L8 5.29297L12.708 10.001L8 14.709Z"
                            ...
                            <li class="nav-item mb-3">
                                <a href="privacy-policy.html" class="nav-link p-0 fw-normal fs-14">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M8 14.709L7.229 13.939L11.167 10.001L7.229 6.06297L8 5.29297L12.708 10.001L8 14.709Z"
                            ...
                            <li class="nav-item mb-3">
                                <a href="terms-conditions.html" class="nav-link p-0 fw-normal fs-14">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M8 14.709L7.229 13.939L11.167 10.001L7.229 6.06297L8 5.29297L12.708 10.001L8 14.709Z"
                ...
                <div class="col-sm-6 col-md-6 col-xxl-6 mb-3">
                    <div class="footer-widget footer-menu ps-xl-4">
                        ...
                        <ul class="nav flex-column">
                            <li class="nav-item mb-3">
                                <a href="social-media-marketing.html" class="nav-link p-0 fw-normal fs-14">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M8 14.709L7.229 13.939L11.167 10.001L7.229 6.06297L8 5.29297L12.708 10.001L8 14.709Z"
                            ...
                            <li class="nav-item mb-3">
                                <a href="search-engine-optimization.html" class="nav-link p-0 fw-normal fs-14">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M8 14.709L7.229 13.939L11.167 10.001L7.229 6.06297L8 5.29297L12.708 10.001L8 14.709Z"
                            ...
                            <li class="nav-item mb-3">
                                <a href="advertisement.html" class="nav-link p-0 fw-normal fs-14">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M8 14.709L7.229 13.939L11.167 10.001L7.229 6.06297L8 5.29297L12.708 10.001L8 14.709Z"
                            ...
                            <li class="nav-item mb-3">
                                <a href="uiux-design.html" class="nav-link p-0 fw-normal fs-14">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M8 14.709L7.229 13.939L11.167 10.001L7.229 6.06297L8 5.29297L12.708 10.001L8 14.709Z"
                            ...
                            <li class="nav-item mb-3">
                                <a href="web-development.html" class="nav-link p-0 fw-normal fs-14">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M8 14.709L7.229 13.939L11.167 10.001L7.229 6.06297L8 5.29297L12.708 10.001L8 14.709Z"
                            ...
                            <li class="nav-item mb-3">
                                <a href="website-maintenance.html" class="nav-link p-0 fw-normal fs-14">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M8 14.709L7.229 13.939L11.167 10.001L7.229 6.06297L8 5.29297L12.708 10.001L8 14.709Z"
                            ...
                            <li class="nav-item mb-3">
                                <a href="hosting-packages.html" class="nav-link p-0 fw-normal fs-14">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M8 14.709L7.229 13.939L11.167 10.001L7.229 6.06297L8 5.29297L12.708 10.001L8 14.709Z"
                            ...
                            <li class="nav-item mb-3">
                                <a href="eCommerce-development.html" class="nav-link p-0 fw-normal fs-14">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M8 14.709L7.229 13.939L11.167 10.001L7.229 6.06297L8 5.29297L12.708 10.001L8 14.709Z"
                            ...
                            <li class="nav-item mb-3">
                                <a href="mobile-app-development.html" class="nav-link p-0 fw-normal fs-14">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M8 14.709L7.229 13.939L11.167 10.001L7.229 6.06297L8 5.29297L12.708 10.001L8 14.709Z"
                ...
                <div class="col-sm-6 col-md-6 col-xxl-2 mb-3">
                    <div class="footer-widget social ps-xl-4">
                        ...
                        <ul class="nav flex-column">
                            <li class="nav-item mb-3">
                                <a href="#" class="nav-link p-0 fw-normal fs-14">
                                    <span>
                                        <svg class="mt-0" width="16" height="16" viewBox="0 0 16 16" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
