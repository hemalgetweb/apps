...
<div class="testimonial-area pt-103">
    <div class="container">
        <div class="apps-fz-testimonial-wrapper-main-6 p-rel">
            <?php if(!empty($settings['section_title'])) : ?>
                <div class="apps-fz-section-title-wrapper-6 text-center pb-25">
                    <h3 class="apps-fz-section-title-6 mb-0"><?php echo cb_core_kses_basic($settings['section_title']); ?></h3>
                </div>
            <?php endif; ?>
            <div class="row justify-content-center">
                <div class="col-xxl-6 col-xl-8 col-lg-9">
                    <?php if(!empty($settings['slides'])) : ?>
                    <div class="apps-fz-testimonial-review-wrapper-6 p-rel">
                        <div class="apps-fz-testimonial-review-active-6 swiper-container pb-70">
                            <div class="swiper-wrapper">
                                <?php foreach($settings['slides'] as $slide) : 
                                    $user_image = $slide['user_image']['url'];    
                                ?>
                                <div class="swiper-slide">
                                    <div class="apps-fz-testimonial-single-6 text-center">
                                        <div class="arrow">
                                        ...
                                        <?php endif; ?>
                                        <div class="apps-fz-testimonial-author-box-6">
                                            <?php if(!empty($slide['user_rating'])) : ?>
                                            <div class="apps-fz-testimonial-author-rating-6">
                        ...
                        <div class="apps-fz-testimonial-bg-shape-6">
                        ...
                        <div class="apps-fz-testimonial-arrow-6">
                        ...
                        <?php endif; ?>
                        <div class="apps-fz-testimonial-paginate-6"></div>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
            <div class="apps-fz-restimonial-line-bottom-6">
