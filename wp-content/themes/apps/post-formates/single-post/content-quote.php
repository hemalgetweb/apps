...
<article id="post-<?php the_ID(); ?>" <?php post_class('single-blog mb-40 format-quote'); ?>>
    <div class="single-blog-txt">
        <div class="apps-post-content-single">
	...
	?>	<div class="row">
		<div class="col-sm-6">
			...
			<a href="<?php echo esc_url($prev_title_link); ?>" class="blog-nav-txt d-block mb-30">
				<span class="blog-nav-title d-block fw-bold color-9 tt-uppercase mb-15"><i class="icofont-double-left"></i> <?php echo esc_html__('Previous Article', 'apps'); ?></span>
		...
		<div class="col-sm-6">
			<?php if(!empty($next_title)) : ?>
				<a href="<?php echo esc_url($next_title_link); ?>" class="text-end blog-nav-txt d-block mb-30">
					<span class="blog-nav-title d-block fw-bold color-9 tt-uppercase mb-15"><?php echo esc_html__('Next Article', 'apps'); ?> <i class="icofont-double-right"></i></span>
