<div class="apps-fz-faq-area-inner-2">
    <div class="container">
        <div class="row">
            <div class="col-xxl-8 col-xl-8 col-lg-12 mb-30 mb-xl-0">
                <div class="apps-fz-faq-box-wrapper-main-inner-2 mb-50">
                    <?php if(!empty($settings['faq_sec_title'])) : ?>
                        <h4 class="apps-fz-faq-title-inner-2"><?php echo cb_core_kses_basic($settings['faq_sec_title']); ?></h4>
                    <?php endif; ?>
                    <?php if(!empty($settings['slides'])) : ?>
                    <div class="apps-fz-faq-box-inner-2">
                        <div class="accordion" id="apps-fz-inner-faq-2">
                            ...
                            <div class="accordion-item">
                                ...
                                <?php endif; ?>
                                <div id="collapse_<?php echo esc_attr($index); ?>" class="accordion-collapse collapse <?php echo esc_attr($collapse_class); ?>" aria-labelledby="faqInner_<?php echo esc_attr($index); ?>" data-bs-parent="#apps-fz-inner-faq-2">
                ...
                <div class="apps-fz-faq-box-wrapper-main-inner-2">
                    <?php if(!empty($settings['faq_sec_title_2'])) : ?>
                        <h4 class="apps-fz-faq-title-inner-2"><?php echo cb_core_kses_basic($settings['faq_sec_title_2']); ?></h4>
                    <?php endif; ?>
                    <?php if(!empty($settings['slides_2'])) : ?>
                    <div class="apps-fz-faq-box-inner-2">
                        <div class="accordion" id="apps-fz-inner-faq-22">
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapse_<?php echo esc_attr($index); ?>_2" class="accordion-collapse collapse <?php echo esc_attr($collapse_class); ?>" aria-labelledby="faqInner_<?php echo esc_attr($index); ?>_2" data-bs-parent="#apps-fz-inner-faq-22">
                                    <div class="accordion-body">
                                        <p class="content">
            ...
            <div class="col-xxl-4 col-xl-4 col-lg-12">
                <div class="apps-fz-find-sidebar-inner-2 ml-50">
                    <?php if(!empty($settings['section_widget_title'])) : ?>
                        <h4 class="apps-fz-faq-title-inner-2"><?php echo cb_core_kses_basic($settings['section_widget_title']); ?></h4>
                    <?php endif; ?>
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-xxl-12 col-xl-12 col-lg-4 col-md-6 mb-30">
                            <div class="apps-fz-faq-contact-box-inner-2">
                                <div class="icon">
