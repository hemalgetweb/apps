...
<?php wp_body_open(); ?>
	...
	<?php endif; ?>
		...
		<?php if($cbtoolkit_preloader) : ?>
			<!-- preloader begin -->
			<div class="apps-rv-preloader">
				<div class="apps-rv-preloader-inner-3421">
					<div class="apps-rv-scene">
						<svg viewBox="0 0 58 58" id="apps-rv-mustard-2344" class="apps-rv-product-3244">
							<g>
						...
						<svg viewBox="0 0 49.818 49.818" id="meat" class="apps-rv-product-3244">
							<g>
						...
						<svg viewBox="0 0 49 49" id="soda" class="apps-rv-product-3244">
							<g>
						...
						<div class="apps-rv-cart-container">
							<svg  viewBox="0 0 512 512" id="apps-rv-cart-2344">
								...
								<polygon style="fill:#FF583E;" class="has-poligon-theme-bg" points="411.2,124.8 224,124.8 170.4,124.8 136.8,124.8 68,124.8 141.6,361.6 427.2,361.6 
									511.2,124.8 "/>
								<g>
